...
@Component({ selector: 'app-forum-posts', standalone: true, imports: [CommonModule], templateUrl: './forum-posts.html', styleUrl: './forum-posts.scss' })
export class ForumPostsComponent {
  ...
  protected readonly posts = signal<Post[]>([
    {
      id: 1,
      author: 'Dr. Julian V.',
      avatar: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBPYE6hQHS-h_dJ8aBWFTo-Jj3QTLHvayo94uCOWa3_vnFQslgHsnDTyxBRwhL-KhKB1e-1Gsj48doyEH0xYwPKkQJbuSicGiKZZoIPOqYl6GkqMT7chvJomyBuXSIS5kUoL9DNBulpu8_fAFhyrPaPfo83XmS1AaYypW7MCo4BeFmk2t_3_78BWJeVwO4PZ3Q2he1ES9lpU6rtz2uC5WnJdndXp56rkhe2ul6mBFGLRRXLmJFcNsAR5QUFMcy3b1jMlv4I8OTW1w3k',
      time: 'Hace 2 horas',
    ...
    },
    {
      id: 2,
      author: 'Sarah Chen',
      avatar: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDKNl16PUrswAbzeZ80af9kPB8OIgyj-gg0Hj4HOjWS3hOU8SIYw0VMUhrfkZC-v3VbBzg05vcjMUabrpjPE86WhBMjVDu4vMMpBt705O4HY1Ml6O2VAqh9R6pqHDxjdu5pl20vagG68BzhUIxhUdtr9jhJpk4Q0JHm6FT1dnmhsUyKiyKV8lQRNFyBGwcmqH_tjXngWRSqNJX9SH-CVM729F3dFg4NVDhww7eT37jgB3_0JuuhvYNatJtdoXG7uro4XgV2NnV6oZ5A',
      time: 'Hace 5 horas',
  ...
  protected toggleVote(post: Post, direction: 'up' | 'down'): void {
  ...
  protected toggleBookmark(post: Post): void {
    const current = this.getState(post);
    this.postStates.update((state) => ({
      ...state,
  ...
  protected toggleComments(post: Post): void {
    const current = this.getState(post);
    this.postStates.update((state) => ({
      ...state,
  ...
  private loadStates(): void {
    ...
    const initialState = this.posts().reduce((state, post) => {
